...
:root {
  ...
  --surf: #1a1a17;
  --surf2: #22221e;
  --border: rgba(245, 239, 223, 0.08);
  --border2: rgba(245, 239, 223, 0.16);
  --txt: #f5efdf;
...
.belt.white { background: var(--belt-white); border: 0.5px solid var(--border2); }
.belt.blue { background: var(--belt-blue); }
.belt.purple { background: var(--belt-purple); }
.belt.brown { background: var(--belt-brown); }
.belt.black { background: var(--belt-black); border: 0.5px solid var(--border2); }
